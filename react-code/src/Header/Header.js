  ...
  return (
    <div id={HeaderCSS.navBar}>
      ...
      <ul id={HeaderCSS.navList}>
        ...
        {localStorage.getItem("role")=="professor"?<li><NavLink to="/administratoret">ADMINISTRATORET</NavLink></li>:null}
        {localStorage.getItem("role")=="student"?<li><NavLink to="/smis/transkripta">SMIS</NavLink></li>:null}
        {localStorage.getItem("role")=="admin"?<li><NavLink to="/staff">STAFF</NavLink></li>:null}
