                ...
                <table>
                    ...
                    {waitlista.map(waitlista=>
                        <tr key={waitlista.StudentiID}>
                            ...
                            <td>
                            <button title="View Student Data" type="button" onClick={()=>this.viewData()}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
