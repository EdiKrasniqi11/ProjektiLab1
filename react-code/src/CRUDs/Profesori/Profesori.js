...
export class Profesori extends Component{
    ...
    viewData(profesoret){
        let shteti = this.state.vendbanimet.find(element => element.VendbanimiID == profesoret.Vendbanimi).Shteti;
        let qyteti = this.state.vendbanimet.find(element => element.VendbanimiID == profesoret.Vendbanimi).Shteti;
        this.setState({
            ProfesoriID:profesoret.ProfesoriID,
    ...
    render(){
        ...
        return(
            <div className={stylist.profesoriDiv}>
                ...
                <table>
                    ...
                    {profesoret.map(profesoret=>
                        <tr key={profesoret.ProfesoriID}>
                            ...
                            <td>
                            <button type="button" onClick={()=>this.viewData(profesoret)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                ...
                {dataModal?<ProfesorData modalSwitch={()=>this.setState({dataModal:false})}>
                    <p>{this.state.ProfesoriID}</p>
                    <p>{this.state.Emri} {this.state.Mbiemri}</p>
                    <p>{this.state.GradaAkademike}</p>
                    <p>{this.state.NrTelefonit}</p>
