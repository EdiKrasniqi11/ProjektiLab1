...
export class Termini extends Component{
    ...
    changeTerminet = (e) =>{
        this.setState({Terminet: e.target.value})
    }
    
    createClick(){
        console.log(this.state.Studenti + ' - ' + this.state.Terminet)
                    ...
                    <div id={stylist.formTerminet}>
                       ...
                       { /*{TerminiStatus==0?*/}
                        ...
                        <div id={stylist.terminiInputDiv}>
                            <select onChange={this.changeTerminet} value={Terminet}>
                                <option value="0">Terminet</option>
